...
namespace hr_jide.Controllers
{
    public class RelationshipsController : Controller
    {
        ...
        {
            return View(await _context.Relationship.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CreatedDate,ModifiedDate,CreatedBy,ModifiedBy")] Relationship relationship)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,CreatedDate,ModifiedDate,CreatedBy,ModifiedBy")] Relationship relationship)
        {
