...
namespace hr_jide.Controllers
{
    public class MembershipsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CreatedDate,ModifiedDate,CreatedBy,ModifiedBy")] Membership membership)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,CreatedDate,ModifiedDate,CreatedBy,ModifiedBy")] Membership membership)
        {
            if (id != membership.Id)
            {
                return NotFound();
